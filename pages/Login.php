    ...
    <div class="navbar">
      ...
      <div class="linkside">
        <ul>
          ...
          <li><a href="signup.php" class="signupbutton">Signup</a></li>
        </ul>
      </div>
    </div>
    ...
    <div class="cardright">
      ...
      <div class="form">
        <form method="post">
          ...
          <input class="inputbox" type="password" id="password" name="password" placeholder="Enter password"><br><br>
          <input type="submit" id="submitButton"class="submitbutton" value="Submit"><br>
        </form>   
      </div>
      <div class="formbottom">
        <span class="linktootherpage">Didn't have an account?</span>
        <a class="signuppagelink" href="signup.php"> Sign Up</a>
      </div>
    </div>
